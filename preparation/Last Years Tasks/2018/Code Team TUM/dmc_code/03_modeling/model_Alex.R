...
x_train_tbl <- as.data.frame(data.matrix(data_tr[,-36]))
#x_test_tbl  <- as.data.frame(data.matrix(data_te[,-37]))
x_train_tbl <- as.data.frame(data.matrix(x_train_tbl[,-36]))
...
table(pred)
#actual = as.data.frame(pull(data[1000000:1473665,], bins))
